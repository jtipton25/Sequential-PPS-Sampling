...
%
  Six different sampling schemes were considered %% Others to consider are Bitterlich sampling (similar to PPS, selection probability depends on tree size and distance from plot center) - definitely worth pursuing - See Gregorie and Valentine
